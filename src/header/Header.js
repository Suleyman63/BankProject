  ...
  return (
    <div className="nav-container">
      <Container fluid className="nav-top-fluid">
        <Container className="nav-top pt-2 pb-0">
          <Row>
  ...
  return (
    <div>
      <Nav variant="tabs" defaultActiveKey="cards" onSelect={handleNavClick}>
        <Nav.Item>
          <Nav.Link className="topnav" eventKey="product">
            Products
          </Nav.Link>
        </Nav.Item>
        <Nav.Item>
          <Nav.Link className="topnav" eventKey="price">
            Prices
          </Nav.Link>
        </Nav.Item>
        <Nav.Item>
          <Nav.Link className="topnav" eventKey="advantage">
            Advantage
          </Nav.Link>
        </Nav.Item>
      </Nav>
          ...
          <Nav.Item>
            <Nav.Link bsPrefix="middle-navbar" as={Link} to="/register">
              <Icon
                ...
                circular
                size="large"
                className="reg d-block mb-2 ms-2"
              ></Icon>
              Register
            </Nav.Link>
          </Nav.Item>
    ...
    <Navbar expand="md">
      ...
      <Navbar.Collapse id="basic-navbar-nav">
        ...
        >
          ...
          <Nav.Link className="nav-bottom-links" eventKey="loans">
            Loans
          </Nav.Link>
          <Nav.Link className="nav-bottom-links" eventKey="mylocation">
            Location
          </Nav.Link>
